...
use crate::synthesis::utils::{add_pgn_result, calculate_ratings, plot_ratings, rankings};

pub fn evaluator<B:Backend,G: Game<N>, P: Policy<G, N> + NNPolicy<B, G, N>, const N: usize>(
